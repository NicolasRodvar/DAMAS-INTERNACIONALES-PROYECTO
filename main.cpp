...
int main() {
    ...
    // ---- BLOQUE NUEVO: mostrar el menú antes de cargar el tablero ----
    Menu menu;
    bool iniciar = menu.showMenu(window);  // muestra el menú
    ...
    if (!iniciar) {
        ...
        const float        boardOffsetY = 270.f * scale;   // margen sup dentro de la ventana
